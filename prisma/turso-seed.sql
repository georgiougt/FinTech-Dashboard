-- Seed data for Turso database
-- Run this in Turso SQL Console to populate your app with data
...
-- Note: Dates are hardcoded for consistency, in a real app you might want them relative to today
